...
public class Blowfish
{
    ...
    private void Blowfish_encipher(ref uint xl, ref uint xr)
    {
        ...
        Xl ^= PArray[0];
        this.ROUND(ref Xr, Xl, 1);
        this.ROUND(ref Xl, Xr, 2);
        this.ROUND(ref Xr, Xl, 3);
        this.ROUND(ref Xl, Xr, 4);
        this.ROUND(ref Xr, Xl, 5);
        this.ROUND(ref Xl, Xr, 6);
        this.ROUND(ref Xr, Xl, 7);
        this.ROUND(ref Xl, Xr, 8);
        this.ROUND(ref Xr, Xl, 9);
    ...
    private void Blowfish_decipher(ref uint xl, ref uint xr)
    {
        ...
        this.ROUND(ref Xl, Xr, 9);
        this.ROUND(ref Xr, Xl, 8);
        this.ROUND(ref Xl, Xr, 7);
        this.ROUND(ref Xr, Xl, 6);
        this.ROUND(ref Xl, Xr, 5);
        this.ROUND(ref Xr, Xl, 4);
        this.ROUND(ref Xl, Xr, 3);
        this.ROUND(ref Xr, Xl, 2);
        this.ROUND(ref Xl, Xr, 1);
        Xr ^= PArray[0];
