namespace SRGame.Client.Cryptography;

public class SkillCryptographyProvider
{
    private const int BaseKey = 0x8C1F;
    ...
    public void DecryptStream(Stream inputStream, out Stream outputStream, int baseKey = BaseKey)
    {
    ...
    public void EncryptStream(Stream inputStream, out Stream outputStream, int baseKey = BaseKey)
    {
        var inputLength = inputStream.Length;
